...
export const ATTR_GROUPS: AttrGroup[] = [
  ...
  },
  {
    ...
    columns: [
      { key: 'part_number', label: '件号', mono: true, searchable: true, width: '110px' },
      { key: 'name', label: '名称', searchable: true, width: '120px' },
      { key: 'internal_grounding', label: '内部共地', searchable: true, width: '80px' },
      { key: 'shell_grounding_method', label: '壳体接地', searchable: true, width: '80px' },
      { key: 'shell_grounding_fault_path', label: '故障路径', width: '70px' },
      { key: 'grounding_special_requirements', label: '接地要求', searchable: true, width: '80px' },
      { key: 'grounding_terminal_diameter', label: '端子内径', width: '65px' },
      { key: 'bonding_method', label: '搭接方式', width: '70px' },
      { key: 'bonding_type', label: '搭接类型', width: '70px' },
      { key: 'bonding_resistance', label: '阻值mΩ', width: '65px' },
    ],
  },
  {
