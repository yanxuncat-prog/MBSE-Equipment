...
EXPORT_COLUMNS = [
    ...
    ("二阶段装机", "equipment", "phase2_onboard"),
    ...
    ("DO-160鉴定等级", "equipment", "do160_temp_qual_level"),
    ("DO-160鉴定符合", "equipment", "do160_temp_compliance"),
    ("正常工作温度(℃)", "equipment", "normal_operating_temp"),
    ("短时工作温度(℃)", "equipment", "short_term_temp"),
    ("地面停放温度(℃)", "equipment", "ground_storage_temp"),
    ("高度(m)", "equipment", "operating_altitude"),
    ("鉴定报告编号", "equipment", "qual_report_number"),
    ("负责人", "equipment", "responsible_person"),
    ("备注", "equipment", "notes"),
]
